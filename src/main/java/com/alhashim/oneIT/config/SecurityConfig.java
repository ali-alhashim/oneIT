    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/clearance/list").hasAnyRole("ADMIN","HR","MANAGER","SUPPORT","VEHICLE","MEDICAL","FINANCE")
                        .requestMatchers("/clearance/clearanceDetail").hasAnyRole("ADMIN","HR","MANAGER","SUPPORT","VEHICLE","MEDICAL","FINANCE")
